classdef intan_RHD2164 < hardware.headstage.headstage
    
    properties
    end
    
    methods
        function p = intan_RHD2164(varargin)
...
%            p.channelMap   = [nan 24:-1:9 nan nan 25:32 1:8 nan]; % from
            channelMap1 = [nan 17:2:47 nan nan 18:2:48 nan];
            channelMap2 = [nan 16:-2:2 64:-2:50 nan nan 15:-2:1 63:-2:49 nan];
            p.channelMap   = flip([channelMap1 channelMap2]);% from
% 
        end
