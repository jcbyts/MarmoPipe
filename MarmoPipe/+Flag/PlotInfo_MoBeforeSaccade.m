function PlotInfo_MoBeforeSaccade(Info)
  ...
  ylabel('Spike Counts');
  V = axis;
  h = text((V(1)+0.05*(V(2)-V(1))),(V(3)+0.9*(V(4)-V(3))),...
       sprintf('Wid A(%3.0f,%3.0f) U(%3.0f,%3.0f)',Awidstim.mu,Awidstim.sem,Uwidstim.mu,Uwidstim.sem));
  set(h,'FontSize',8);
  h = text((V(1)+0.05*(V(2)-V(1))),(V(3)+0.8*(V(4)-V(3))),...
       sprintf('Fit(%+8.2f,%+8.2f)',Afvalstim, Ufvalstim));
  set(h,'FontSize',8);
  ...
  V = axis;
  h = text((V(1)+0.05*(V(2)-V(1))),(V(3)+0.9*(V(4)-V(3))),...
       sprintf('Wid A(%3.0f,%3.0f) U(%3.0f,%3.0f)',Awidpre.mu,Awidpre.sem,Uwidpre.mu,Uwidpre.sem));
  set(h,'FontSize',8);
  h = text((V(1)+0.05*(V(2)-V(1))),(V(3)+0.8*(V(4)-V(3))),...
       sprintf('Fit(%+8.2f,%+8.2f)',Afvalpre, Ufvalpre));
  set(h,'FontSize',8);
