function FitPreSaccadicData(SampleData)
%% load data
...
fit1 = vonMises.fit_vonmises(theta(cond==1), count(cond==1), useBootstrapping);
fit2 = vonMises.fit_vonmises(theta(cond==0), count(cond==0), useBootstrapping);
